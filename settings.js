 ...
 ******************************************************************************/
    ...
    /** DSLFlow platform restriction — disabled built-in nodes
     * These core Node-RED nodes are intentionally removed from the runtime.
     * Custom @inteli.city nodes must be used as the approved alternatives.
     *
     * Disabled nodes and their replacements:
     *   http in        → @inteli.city/node-red-contrib-http-plus (http-plus-in)
     *   http response  → @inteli.city/node-red-contrib-http-plus (http-plus-response)
     *   http request   → @inteli.city/node-red-contrib-http-plus (http-plus-request)
     *   exec           → @inteli.city/node-red-contrib-exec-collection
     *   template       → @inteli.city/node-red-contrib-http-plus or Function node
     *
     * Matched by basename. See @node-red/registry/lib/localfilesystem.js.
     */
    nodesExcludes: [
        '21-httpin.js',      // http in + http response
        '21-httprequest.js', // http request
        '90-exec.js',        // exec
        '80-template.js',    // template (mustache)
        '22-websocket.js',   // websocket in + websocket out
    ],
 ...
 ******************************************************************************/
    ...
    editorTheme: {
        ...
        palette: {
             ...
             */
            categories: ['subflows', 'common', 'dsl', 'function', 'network', 'sequence', 'parser', 'storage'],
        },
